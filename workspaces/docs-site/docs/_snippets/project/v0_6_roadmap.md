...
**GitHub snapshot:** 2026-08-30. In this map, **complete** means the GitHub issue is closed; **open** means it remains unfinished. Complete issue nodes are green; open nodes retain the gold outline.
...
<table class="inc-v06-roadmap-table">
  ...
  <tbody>
    ...
    <tr data-v06-slice-target="slice-02-first-executable-proof">
      <td><button type="button" class="inc-v06-slice-toggle">2. First executable proof</button><div class="inc-v06-slice-status"><span class="inc-v06-status inc-v06-status--complete">1 complete</span><span class="inc-v06-status inc-v06-status--open">7 open</span></div></td>
