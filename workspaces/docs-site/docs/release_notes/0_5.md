...
## v0.5.1-dev.17: targeted patch validation

`v0.5.1-dev.17` is a development build for Incan's first patch release. It is not a release candidate and does not add a new language or product surface. It is the validation vehicle for the focused repairs tracked under [#1191](https://github.com/encero-systems/incan/issues/1191).
