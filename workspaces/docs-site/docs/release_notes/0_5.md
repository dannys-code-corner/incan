...
## v0.5.1: patch-release candidate under validation

The `v0.5.1` release candidates are the validation vehicle for Incan's first patch release. They do not add a new language or product surface; they carry the focused repairs tracked under [#1191](https://github.com/encero-systems/incan/issues/1191).
