...
## v0.5.1-rc2: current patch-release candidate

`v0.5.1-rc2` is the current release candidate for Incan's first patch release. It does not add a new language or product surface. It is the validation vehicle for the focused repairs tracked under [#1191](https://github.com/encero-systems/incan/issues/1191).

Repairs under validation in this candidate:
