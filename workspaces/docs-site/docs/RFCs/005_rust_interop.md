...
Define seamless Rust interop for Incan: imports like `rust::serde_json` should work without manual Cargo edits, with
clear type mapping, codegen, and build integration.
