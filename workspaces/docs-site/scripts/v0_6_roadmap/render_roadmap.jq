def slices:
  [
    ...
    { number: 8, issue_number: 433, slug: "native-windows", title: "Native Windows support", focus: "A Windows host that builds, bakes, and ships like the others.", proof: "A packaged Windows toolchain builds and runs a project, not merely a bake that exits zero.", exit_evidence: "the release bake produces a Windows archive; that archive, extracted and installed, scaffolds a project and builds it; platform-gated behaviour is implemented or its divergence is stated in code and docs." },
