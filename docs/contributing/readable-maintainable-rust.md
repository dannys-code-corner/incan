...
> A pragmatic set of principles, patterns, and guardrails to help teams write Rust that’s easy to understand and safe to
> evolve.
...
3. **Error taxonomy**
   ...
   - In this repo: compiler diagnostics are typically built with `miette`, and shared runtime/semantic errors should
        stay aligned (see [Layering Rules](/docs/contributing/layering.md)).
