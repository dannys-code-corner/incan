Warning: truncated output (original token count: 20067)
  ...
  "exports": {{
    "enums": [
      {{
        ...
        "value_type": "str",
        "variants": [
          {{ "name": "Active", "fields": [], "value":…67 tokens truncated…tches!(err, Err(LibraryManifestError::Invalid(ref msg)) if msg.contains("is missing a raw value")),
