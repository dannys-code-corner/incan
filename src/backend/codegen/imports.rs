...
impl RustCodegen<'_> {
    ...
    pub(crate) fn emit_prelude(&mut self) {
        ...
        // Suppress Rust lints in generated code.
        //
        // Users write `.incn`, not Rust. When we surface Rust warnings from generated crates,
        // they often can't action them (and they obscure real compiler errors).
        //
        // Note: keep this as a crate-level attribute; multi-file projects must place it
        // before any `mod ...;` declarations.
        // This must be a crate-level attribute; multi-file projects ensure it is placed
        // before any `mod ...;` declarations.
        self.emitter.line("#![allow(unused_imports, unused_parens, dead_code, unused_variables, unused_mut, unused_assignments)]");
        self.emitter.blank_line();
