...
pub use metadata::{
    ...
    RustParam, RustTraitAssoc, RustTraitInfo, RustTypeInfo, RustTypeMetadataCompleteness, RustTypeShape,
    RustTypeShapePathFallback, RustVariantInfo, RustVisibility, ancestral_rust_display, ancestral_rust_path,
